...
#'
#'
#' @description It generates a list of n Sampled Random Walks along with the appropriate time period.
...
#' @return \code{srwalkGenerator()} has as output a list of data.frame.
