...
-   Joint Distribution Function to characterize the distribution of
    brownian motion: []()
...
srwalk() outputs a data.frame which contains each time step along with
the associated Sampled Random Walk value, arranged as follow:
...
<tr class="odd">
<td>time_to_maturity</td>
<td>Maximum time up to the Brownian Motion evolves</td>
<td></td>
</tr>
<tr class="even">
<td>scale</td>
<td>It defines the time partition between each unit of time. For instance if the scale is 100, the time step [0,1] will be cut in 100 parts.</td>
<td></td>
</tr>
<tr class="odd">
<td>seed</td>
<td>With same seed, 2 exeriments will(would, in fact not yet the case when the param scale is different) give the same output. It therefore provides reproducibles experiments.</td>
<td></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td>n</td>
<td>Number of samples generated by the function</td>
<td></td>
</tr>
</tbody>
</table>
...
![Brownian Motion path up to time to maturity fixed at
4](README_files/figure-markdown_strict/unnamed-chunk-15-1.png)
